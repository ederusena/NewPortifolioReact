  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Portifolio por Eder Sena Desenvolvedor Frontend Vue React Angular" />
      </Head>
        ...
        <Layout className="pt-0 md:pd-16 sm:pt-8">
          <div className="flex items-center justify-between w-full lg:flex-col">
            ...
            <div className="flex flex-col items-center self-center w-1/2 lg:w-full lg:text-center">
              ...
              <p className="my-4 text-base font-medium lg:text-center sm:text-xs">{textSubtitle}</p>
