...
const Footer = () => {
  return (
    <footer className="w-full text-lg font-medium border-t-2 border-solid border-dark dark:border-light ">
      <Layout className="flex items-center justify-between py-8 dark:text-light">
        <span>
