...
const NavBar = () => {
  ...
  return (
    <header className="relative flex items-center justify-between w-full px-32 py-8 font-medium lg:py-10 dark:text-light dark:bg-darkNav">
      <button
      ...
      {/* Mobile nav */}
      {isOpen && (
        <motion.div initial={{scale: 0, opacity: 0, x: "-50%", y: "-50%"}} animate={{scale:1,opacity: 1}} className="min-w-[70vw] flex flex-col justify-between items-center fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-30 bg-dark/90 dark:bg-light/75 dark:text-dark rounded-lg backdrop-blur-lg py-32 gap-2">
